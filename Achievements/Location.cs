...
public class Location {
	...
	public static readonly Location ISLAND_RUNWAY = new Location(Body.KERBIN, 1.51111.south(), 71.96888.west(), 1.53583.south(), 71.85055.west());

	public static readonly Location ARMSTRONG_MEMORIAL = new Location(Body.MUN, 0.7025.north(), 22.74694.east(), 100);
	...
	public Location(Body body, double latitude, double longitude, double radius) {
		this.body = body;
	...
	public Location(Body body, double latitude, double longitude, double latitude2, double longitude2) {
		this.body = body;
		this.latitude = latitude;
		this.longitude = longitude;
	...
	public bool isAtLocation(Vessel vessel) {
